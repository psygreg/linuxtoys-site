const DOCS_FILES = {
  en: new URL("docs/content/docs.en.md", document.baseURI).href,
  "pt-BR": new URL("docs/content/docs.br.md", document.baseURI).href
};
...
function translateInterface(lang) {
  ...
  document.title = lang === "pt-BR"
    ? "Documentação — LinuxToys"
    : "Documentation — LinuxToys";
