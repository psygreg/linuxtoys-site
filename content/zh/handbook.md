...
开始之前，请查看[开发者手册](https://codeberg.org/psygreg/linuxtoys/wiki/Developer-Handbook)以获取LinuxToys库和开发实践的完整文档。
...
1. 查看[开发者手册](https://codeberg.org/psygreg/linuxtoys/wiki/Developer-Handbook)
2. 分叉仓库并创建功能分支
3. 按照开发优先级进行更改
4. 在支持的系统上彻底测试
5. 提交带有清楚更改描述的拉取请求
...
我们理解让LinuxToys可以用人们的母语使用是非常重要的，因为这使软件更容易获得，这是我们成功的关键因素。然而，这也是一项非常耗时的任务，比我们大得多的项目也在努力寻找志愿者来帮助这项工作，所以我们使用AI工具来生成翻译。翻译中的任何不准确或错误都应该在我们的[GitHub问题页面](https://codeberg.org/psygreg/linuxtoys/issues)上报告。
