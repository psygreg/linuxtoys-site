...
Antes de comenzar, por favor revisa el [Manual del Desarrollador](https://codeberg.org/psygreg/linuxtoys/wiki/Developer-Handbook) para documentación completa sobre las librerías de LinuxToys y prácticas de desarrollo.
...
1. Revisa el [Manual del Desarrollador](https://codeberg.org/psygreg/linuxtoys/wiki/Developer-Handbook)
...
- **`# negates:`** - Oculta los siguientes scripts si el script con este encabezado se encuentra compatible con la máquina del usuario. Puede tener múltiples scripts separados por comas, sin la extensión `.sh`.
